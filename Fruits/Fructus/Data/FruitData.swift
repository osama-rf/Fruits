...
//  Fructus
//
//  Created by osama refae on 25/01/2022.
//
...
let fruitData: [Fruit] = [
  Fruit(
    title: "التفاح",
    headline: "يعتبر التفاح أحد أكثر الفاكهة شعبية وصحية بشكل استثنائي لاسباب وجيهة.",
    image: "apple",
  ...
  Fruit(
    title: "الليمون",
    headline: "ليس هناك شك في أن الليمون لذيذ وفوائده كثيرة ، لكن هل إضافته إلى الماء تجعلك أكثر صحة؟",
    image: "lemon",
    ...
    Fruit(
      title: "الفراولة",
      headline: "تحظى بتقدير كبير بسبب شكلها المميزة ولونها الأحمر ومذاقها الشهي والحلو.",
      image: "strawberry",
  ...
  Fruit(
    title: "المانجو",
    headline: "الفاكهة الاستوائية الغنية عن التعريف التي تحتوي على الكثير من الفوائد هل تعرفعها كلها؟",
    image: "mango",
  ...
  Fruit(
    title: "الخوخ",
    headline: "الخوخ فاكهة مغذية للغاية. مصدر ممتاز للفيتامينات والمعادن والألياف ومضادات الأكسدة.",
    image: "plum",
